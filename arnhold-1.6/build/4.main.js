...
var PushSettingsModule = (function () {
...
PushSettingsModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__push_settings__["a" /* PushSettings */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_push_push__ = __webpack_require__(120);
...
PushSettings = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/Users/matt/projects/appp/ap3/src/pages/push-settings/push-settings.html"*/'<ion-header>\n  <ion-toolbar>\n    <ion-title>\n      {{ \'Notification Settings\' | translate }}\n    </ion-title>\n    <ion-buttons end>\n      <button ion-button (click)="dismiss()">\n        <ion-icon name="close"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n\n<ion-list>\n<ion-item *ngFor="let segment of segments">\n  <span item-left class="dot"></span>\n  <ion-label>{{segment.name}}</ion-label>\n  <ion-toggle [(ngModel)]="segment.isChecked" (ionChange)="toggleSegment($event, segment, segments)"></ion-toggle>\n</ion-item>\n<ion-item *ngIf="!segments">No segments available</ion-item>\n</ion-list>\n\n</ion-content>'/*ion-inline-end:"/Users/matt/projects/appp/ap3/src/pages/push-settings/push-settings.html"*/,
